...
from Contracts.contract import compile
from Contracts.main_buyer import purchase_bond, claim_interest, claim_par
...
# Again, reference something off chain? 
# is the best solution here to set up own oracle? 
#--------------------------------------------------------------------
